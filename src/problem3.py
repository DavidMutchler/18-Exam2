...
Authors: David Mutchler, Dave Fisher, Matt Boutell, their colleagues,
         and SOLUTION by David Mutchler.  October 2018.
 ...
 s
    ...
    def rain(self, rain_amount):
        ...
        if rain_amount < self.water:
            ...
            amount_rained = rain_amount
        else:
            amount_rained = self.water
            self.water = 0

        self.total_rain_amount = self.total_rain_amount + amount_rained
        return amount_rained
